...
def wandb_inference(
    i_input="Hipertensão arterial", model_name="bert_text_to_icpc2_small"
):
    load_dotenv()
    ...
    artifact_or_name = (
        f"{ORG_ENTITY_NAME}/wandb-registry-{REGISTRY_NAME}/{COLLECTION_NAME}:{ALIAS}"
    )
