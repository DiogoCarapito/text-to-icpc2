...
def mass_validation(experiment):
    ...
    for _, run in list_models.iterrows():
        ...
        try:
            ...
            logging.error(e)
            data = {"accuracy": None, "num_correct_predictions": None, "correct_predictions_list": None}
            continue
        ...
        with open("results_mass_validation.csv", "a") as f:
            f.write(f"{experiment},{run_name},{runid},{data['accuracy']},{data['num_correct_predictions']},{data['correct_predictions_list']}\n")
